...
from app._forms.book import SearchForm
import json

from app._libs.helper import is_isbn_or_key
from app._models.gift import Gift
from app._models.wish import Wish
from flask_login import current_user
from app._spider.yushu_book import YuShuBook
from app._view_models.book import BookViewModel, BookCollection
from app._view_models.trade import TradeInfo
...
def test1():
    ...
    from app._libs.none_local import n
    print(n.v)
    n.v = 2
    print('-----------------')
