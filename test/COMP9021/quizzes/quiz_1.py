...
for i in list(mapping.values()):
    if list(mapping.values()).count(i) == 1:
        new_mapping_values.append(i)

for i in mapping:
    if mapping.get(i) in new_mapping_values:
        one_to_one_part_of_mapping.setdefault(i, mapping.get(i))
print()
